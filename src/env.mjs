...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_AC_TELEGRAM_LINK: z.string(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_AC_TELEGRAM_LINK:
      process.env.NEXT_PUBLIC_AC_TELEGRAM_LINK,
    NEXT_PUBLIC_AC_HELPDESK_LINK:
      process.env.NEXT_PUBLIC_AC_HELPDESK_LINK,
  },
  /**
