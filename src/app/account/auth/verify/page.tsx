          ...
          <div className="flex flex-col gap-6 pb-3 text-sm leading-loose text-text-em-mid md:text-base">
            ...
            <ol className="flex list-decimal flex-col gap-3 pl-5 md:pl-10">
              <li className="">
                ...
                <span>
                  We currently only support emails from these domains:{" "}
                </span>
              ...
              <li>
                ...
                the login links as spam. If so, mark the email as not spam in
                your inbox.
              </li>
              <li>
                <b className="text-text-em-high">
                ...
                will further help reduce the likelihood of emails being flagged
                as spam.
              </li>
            </ol>
            <p>
